...
#ifndef __SSPortraiture_1_Recording_XL__textGen__
#define __SSPortraiture_1_Recording_XL__textGen__
...
public:
    ...
    // draw specified text
    void drawText(int yTranslate = 0, Boolean drawCenter = false);
...
#endif /* defined(__SSPortraiture_1_Recording_XL__textGen__) */