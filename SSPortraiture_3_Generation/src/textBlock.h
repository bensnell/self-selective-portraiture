...
#ifndef __SSPortraiture_3_Generation__textBlock__
#define __SSPortraiture_3_Generation__textBlock__
...
#endif /* defined(__SSPortraiture_3_Generation__textBlock__) */
